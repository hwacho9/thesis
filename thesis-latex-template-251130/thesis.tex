...
\begin{table}[htbp]
\centering
\caption{事後アンケート結果（7点Likert尺度, 平均 $\pm$ SD）}
\label{tab:questionnaire}
\begin{tabular}{lcc}
\hline
\textbf{質問項目} & \textbf{平均} & \textbf{SD} \\
\hline
Q2-6: ゾンビ扉を開けた瞬間の恐怖 & 5.5 & 1.4 \\
Q3-1: ゾンビ追跡開始時の恐怖 & 4.3 & 2.6 \\
Q3-3: 実験終了時の緊張解放感 & 4.0 & 2.0 \\
\hline
\end{tabular}
\end{table}
...
アンケートは7点リカート尺度 (Likert scale) を使用し,実験の進行順序 (探索 $\rightarrow$ ビーカー収集 $\rightarrow$ ゾンビ遭遇 $\rightarrow$ 追跡) に伴う感情変化を追跡した.
...
アンケート結果に基づき, 被験者を3つのタイプに分類した.

\paragraph{没入型恐怖反応群 (Immersion-Fear Group):}
これらの参加者は実験設計の意図通り,Phaseが進行するにつれて (探索 $\rightarrow$ 追跡) 恐怖度が上昇する典型的なパターンを示した.特に参加者 C と E は追跡状況で最高点 (7点) を記録し,強いストレスを訴えた.
...
本研究では, VR体験中のユーザの感情状態をリアルタイムに推定するフレームワークを提案し, その有効性を検証した.
提案手法は, 生体信号(EDA, ECG, EMG)とVR内の行動イベントログを統合的に解析することで, 恐怖や驚きといった感情状態を多角的に評価することを可能にした.
実験の結果, 恐怖刺激に対するEDAの有意な上昇や, 驚き反応時のEMGの急激な変化など, 感情状態に対応する生理的特徴が確認された.
また, アンケートによる主観評価と生理反応の相関を分析することで, 提案手法の妥当性が示唆された.
本研究の成果は, ユーザの感情状態に応じて動的に変化する適応型VRコンテンツの実現や, より没入感の高いVR体験の設計に寄与することが期待される.

% 謝辞 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\acknowledgements

本研究を進めるにあたり, 指導教員である井村誠孝教授には多大なるご指導とご鞭撻を賜りました. 心より感謝申し上げます.
また, 実験に参加していただいた被験者の皆様, ならびに研究室の皆様に深く感謝いたします.
