...
生体信号からの感情状態の推定においては20特徴量を用いたLeave-One-Session-Out交差検証の結果，Random Forestが最高精度(Accuracy: 67.7\%，F1: 66.6\%)を示した．Phase~0(安定)のRecall 88\%，Phase~3(追跡)のRecall 71\%と，安定状態と恐怖状態の識別に優れた性能を示した．特徴量の重要度では積分EMG・EMG標準偏差・平均SCL等が上位を占めた．ただし参加者間の精度差(33\%--100\%)が大きく，個人適応機構の必要性が示唆された．
